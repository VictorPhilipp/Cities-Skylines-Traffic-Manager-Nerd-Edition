		...
		public void CustomSimulationStep(ushort vehicleId, ref Vehicle vehicleData, Vector3 physicsLodRefPos) {
			if ((vehicleData.m_flags & Vehicle.Flags.WaitingPath) != 0) {
				...
				if ((pathFindFlags & PathUnit.FLAG_FAILED) != 0 || vehicleData.m_path == 0) {
					...
					//PathPoint[] positions = CustomPathVisualizer.Instance.GatherPathVerticies(vehicleData.m_path);
					//CustomPathVisualizer.Instance.CreatePathGameobject(positions, vehicleId);
