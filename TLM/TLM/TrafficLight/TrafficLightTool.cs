				...
				if (_timedEditStep != i) {
					if (nodeSimulation.TimedTrafficLightsActive) {
						if (i == timedNodeMain.CurrentStep) {
							...
							GUILayout.Space(5);
							GUILayout.EndVertical();
							if (GUILayout.Button(Translation.GetString("Skip"), GUILayout.Width(45))) {
						...
						if (_timedEditStep < 0) {
							...
							if (GUILayout.Button(Translation.GetString("View"), GUILayout.Width(45))) {
							...
							if (GUILayout.Button(Translation.GetString("Edit"), GUILayout.Width(45))) {
								_timedPanelAdd = false;
								_timedEditStep = i;
							...
							if (GUILayout.Button(Translation.GetString("Delete"), GUILayout.Width(60))) {
								_timedPanelAdd = false;
